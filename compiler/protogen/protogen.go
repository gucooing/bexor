...
import (
	...
	"github.com/gucooing/bexor/internal/strs"
...
func (opts Options) New(req *pluginpb.CodeGeneratorRequest) (*Plugin, error) {
	...
	//
	//     option go_package = "github.com/gucooing/bexor/types/known/anypb";
	//
...
// For example: "github.com/gucooing/bexor/compiler/protogen"
